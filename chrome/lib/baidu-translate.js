...
import { getSettingsAsync } from './settings.js';

// ===== 百度翻译 API =====
var BAIDU_API = 'https://fanyi-api.baidu.com/api/trans/vip/translate';

export function toBaiduLang(code) {
    var map = {
...
export async function translateWithBaidu(texts, source, target) {
...
// 翻译路由
export async function doTranslateRequest(text, source, target, format, apiKey) {
    var settings = await getSettingsAsync();
